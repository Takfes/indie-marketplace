...
python ../python-scan/scripts/analyze_multi_metrics.py <file> --format json > complexity_BEFORE.json
python ../python-scan/scripts/check_documentation.py <file> --format json > docs_BEFORE.json
