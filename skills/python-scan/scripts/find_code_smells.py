...
Finds: magic numbers, bare excepts, god classes, data classes, long
       parameter lists. Mutable defaults and type() comparisons are dropped
       here — ruff already covers them (B006, E721).
"""
